...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = _normalize_database_url(os.environ.get('DATABASE_URL', 'sqlite:///kifome.db'))
    ...
    DEV_SMS_FALLBACK_ENABLED = os.environ.get('DEV_SMS_FALLBACK_ENABLED', 'true').lower() == 'true'
